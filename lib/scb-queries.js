...
export const SCB_ENDPOINTS = {
  ...
  green: {
    url: "https://api.scb.se/OV0104/v1/doris/sv/ssd/START/MI/MI0805/MI0805B/GrOmrBefToReg",
    cachePrefix: "green-200m",
    query: (city) => [
      { code: "Region", selection: { filter: "item", values: [city] } },
      { code: "AvstandGrOmr", selection: { filter: "item", values: ["200"] } },
      { code: "ContentsCode", selection: { filter: "item", values: ["0000046N"] } },
      ALL_YEARS,
    ],
  },
  "election-region": {

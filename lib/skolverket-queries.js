...
export const SKOLVERKET_ENDPOINTS = {
  ...
  "preschool-staff": {
    cachePrefix: "skv-preschool-staff",
    url: "https://statistikdatabasen.skolverket.se/PxWeb/api/v1/sv/Skolverkets_statistikdatabas/Kommunala_jamforelsetal/Forskola/Personal/Forskola_personal.px",
    query: (city) => [
      { code: "variable", selection: { filter: "item", values: ["3", "12"] } },
      { code: "level", selection: { filter: "item", values: [city] } },
      ALL_TIME,
    ],
  },
  "upper-results": {
    cachePrefix: "skv-upper-results",
    url: "https://statistikdatabasen.skolverket.se/PxWeb/api/v1/sv/Skolverkets_statistikdatabas/Kommunala_jamforelsetal/Gymnasieskola/Betyg_och_studieresultat/Gymnasieskola_betyg_studieresultat.px",
    query: (city) => [
      { code: "variable", selection: { filter: "item", values: ["7", "34"] } },
      { code: "level", selection: { filter: "item", values: [city] } },
      ALL_TIME,
    ],
  },
